...
export default function RdgrImagePage() {
    ...
    <div className="relative flex flex-col h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      ...
      <main className="flex flex-col flex-grow pt-16">
        <ReplicateImageTool
          ...
          settingsStorageKey="rdgrReplicateSettings"
          historyStorageKey="rdgrReplicateHistory"
          modelWhitelist={['qwenrud']}
          replicateEndpoint="/api/rdgr/replicate"
          enhanceEndpoint="/api/rdgr/enhance-prompt"
          defaultModelKey="qwenrud"
        />
      </main>
    </div>
  );
